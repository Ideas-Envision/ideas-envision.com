    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="login-form" id="access-form-login" method="post">
                <h3 class="form-title font-green">Validación de Cuenta</h3>
                <div class="alert alert-success">
                    <button class="close" data-close="alert"></button>
                    <span> <?Php echo $this->vStatusValidateEmailAccount; ?> </span>
                </div>
                
                <div class="create-account">
                    <p>                        
                        <a class="uppercase" href="<?php echo BASE_VIEW_URL; ?>access">Ingresar</a></br>
                        <a class="uppercase" href="<?php echo BASE_VIEW_URL; ?>access/register">Registrar</a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
