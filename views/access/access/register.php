...
<html lang="es">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" id="access-form-register" method="post">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn green uppercase">Registrar</button>
                    <a href="<?php echo BASE_VIEW_URL; ?>access" id="forget-password" class="forget-password">¿Ya tengo una cuenta?</a>
                </div>
                <div class="create-account">
                    <p><a href="<?php echo BASE_VIEW_URL; ?>access/sendEmailValidation">Validar Cuenta</a></p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
        </div>
