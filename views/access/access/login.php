...
<html lang="es">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" id="access-form-login" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="correo electrónico" name="vEmail" id="vEmail" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Contraseña</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="contraseña" name="vPassword" /> </div>
                ...
                <div class="create-account">
                    <p>                        
                        ...
                        <a class="uppercase" href="<?php echo BASE_VIEW_URL; ?>access/sendEmailValidation">Validar Cuenta</a></br>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
