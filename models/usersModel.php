...
class usersModel extends IdEnModel
	{
		...
		public function getUserNameExists($vUserName)
			{
				...
				$vResultUserExists = $this->vDataBase->query("SELECT
                                                            ...
                                                            WHERE tb_ideasenvision_users.c_username = '$vUserName';");
		...
		public function getUserCodeFromEmailActivationCode($vActivationCode, $vEmail)
			{
				...
				$vResultUserCodeFromEmailActivationCode = $this->vDataBase->query("SELECT
                                                            ...
                                                            FROM tb_ideasenvision_users
                                                                WHERE tb_ideasenvision_users.n_activationcode = $vActivationCode
		...
		public function getUserActivationCode($vEmail)
			{
				...
				$vResultUserActivationCode = $this->vDataBase->query("SELECT
                                                                tb_ideasenvision_users.n_activationcode
                                                            FROM tb_ideasenvision_users
		...
		public function getUser($vUserCode)
			{
				...
				$vResult = $this->vDataBase->query("SELECT
                                                        ...
                                                        tb_ideasenvision_users.n_activationcode,
                                                        tb_ideasenvision_users.n_active,
                                                        tb_ideasenvision_users.c_usercreate,
                                                        tb_ideasenvision_users.d_datecreate,
                                                        tb_ideasenvision_users.c_usermod,
                                                        tb_ideasenvision_users.d_datemod
                                                    FROM tb_ideasenvision_users
                                                        WHERE tb_ideasenvision_users.n_coduser = $vUserCode;");
		...
		public function getUserInfo($vUserCode)
			{
				...
				$vResult = $this->vDataBase->query("SELECT
                                                        ...
                                                        tb_ideasenvision_usernames.n_coduser,
                                                        tb_ideasenvision_usernames.c_names,
                                                        tb_ideasenvision_usernames.c_lastnames,
                                                        tb_ideasenvision_usernames.c_othername,
                                                        tb_ideasenvision_usernames.d_birthdate,
                                                        tb_ideasenvision_usernames.c_country,
                                                        tb_ideasenvision_usernames.c_city,
                                                        tb_ideasenvision_usernames.n_active,
                                                        tb_ideasenvision_usernames.c_usercreate,
                                                        tb_ideasenvision_usernames.d_datecreate,
                                                        tb_ideasenvision_usernames.c_usermod,
                                                        tb_ideasenvision_usernames.d_datemod
                                                    FROM tb_ideasenvision_usernames
                                                        WHERE tb_ideasenvision_usernames.n_coduser = $vUserCode;");
				return $vResult->fetchAll();
				$vResult->close();
			}
		...
		public function getUserNamesComplete($vUserCode)
			{
				...
				$vResult = $this->vDataBase->query("SELECT
                                                        CONCAT(tb_ideasenvision_usernames.c_names,' ',tb_ideasenvision_usernames.c_lastnames) AS c_namescomplete
                                                    FROM tb_ideasenvision_usernames
                                                        WHERE tb_ideasenvision_usernames.n_coduser = $vUserCode;");
		...
		public function userRegister($vUsername, $vPassword1, $vPassword2, $vEmail, $vRole, $vActivationcode, $vActive){
				...
				$vResultUserRegister = $this->vDataBase->prepare("INSERT INTO tb_ideasenvision_users(c_username, c_pass1, c_pass2, c_email, c_userrole, n_activationcode, n_active, c_usercreate, d_datecreate)
		...
		public function userInfoRegister($vUserCode, $vNames, $vLastNames, $vOthername, $vBirthDate, $vCountry, $vCity, $vActive){
				...
				$vResultUserInfoRegister = $this->vDataBase->prepare("INSERT INTO tb_ideasenvision_usernames(n_coduser, c_names, c_lastnames, c_othername, d_birthdate, c_country, c_city, n_active, c_usercreate, d_datecreate)
		...
		public function updateUserStatus($vUserCode, $vActive){
                ...
                $vResultUpdateUserStatus = $this->vDataBase->prepare("UPDATE
                                                tb_ideasenvision_users
                                            SET tb_ideasenvision_users.n_active = :n_active,
                                                tb_ideasenvision_users.c_usermod = :c_usermod,
                                                tb_ideasenvision_users.d_datemod = NOW()
                                            WHERE tb_ideasenvision_users.n_coduser = :n_coduser;")
                                ->execute(
                                            array(
                                                    ':n_active'=>$vActive,
                                                    ':c_usermod'=>$vUserMod,
		...
		public function updateUserInfoStatus($vUserCode, $vActive){
                ...
                $vResultUpdateUserInfoStatus = $this->vDataBase->prepare("UPDATE
                                                tb_ideasenvision_usernames
                                            SET tb_ideasenvision_usernames.n_active = :n_active,
                                                tb_ideasenvision_usernames.c_usermod = :c_usermod,
                                                tb_ideasenvision_usernames.d_datemod = NOW()
                                            WHERE tb_ideasenvision_usernames.n_coduser = :n_coduser;")
                                ->execute(
                                            array(
                                                    ':n_active'=>$vActive,
                                                    ':c_usermod'=>$vUserMod,
