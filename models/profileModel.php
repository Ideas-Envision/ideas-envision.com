...
class profileModel extends IdEnModel
	{
		...
		public function getProfileNameExists($vProfileName)
			{
				...
				$vResultProfileNameExists = $this->vDataBase->query("SELECT
                                                                COUNT(*)
                                                            FROM tb_ideasenvision_profiles
                                                            WHERE tb_ideasenvision_profiles.tb_ideasenvision_profiles = '$vProfileName';");
		...
		public function getProfileCodeFromUserCode($vUserCode, $vProfileType)
			{
				...
				$vResultProfileCodeFromUserCode = $this->vDataBase->query("SELECT
                                                                            tb_ideasenvision_profiles.n_codprofile
                                                                        FROM tb_ideasenvision_profiles
                                                                            WHERE tb_ideasenvision_profiles.n_coduser = $vUserCode
                                                                                AND tb_ideasenvision_profiles.n_profiletype = $vProfileType;");
		...
		public function getProfileFromUserCode($vUserCode)
			{
				...
				$vResultProfileFromUserCode = $this->vDataBase->query("SELECT
                                                                            tb_ideasenvision_profiles.n_codprofile,
                                                                            tb_ideasenvision_profiles.n_coduser,
                                                                            tb_ideasenvision_profiles.c_profilename,
                                                                            tb_ideasenvision_profiles.n_profiletype,
                                                                            tb_ideasenvision_profiles.n_active,
                                                                            tb_ideasenvision_profiles.c_usercreate,
                                                                            tb_ideasenvision_profiles.d_datecreate,
                                                                            tb_ideasenvision_profiles.c_usermod,
                                                                            tb_ideasenvision_profiles.d_datemod
                                                                        FROM tb_ideasenvision_profiles
                                                                            WHERE tb_ideasenvision_profiles.n_coduser = $vUserCode;");
		...
		public function getProfile($vProfileCode)
			{
				...
				$vResultProfile = $this->vDataBase->query("SELECT
                                                                    ...
                                                                    tb_ideasenvision_profiles.d_datemod
                                                                FROM tb_ideasenvision_profiles
                                                                    WHERE tb_ideasenvision_profiles.n_codprofile = $vProfileCode;");
		...
		public function profileRegister($vUserCode, $vProfileName, $vProfileType, $vActive){
				...
				$vResultProfileRegister = $this->vDataBase->prepare("INSERT INTO tb_ideasenvision_profiles(n_coduser, c_profilename, n_profiletype, n_active, c_usercreate, d_datecreate)
		...
		public function updateProfileStatus($vUserCode, $vProfileType, $vActive){
                ...
                $vResultUpdateProfileStatus = $this->vDataBase->prepare("UPDATE
                                                tb_ideasenvision_profiles
                                            SET tb_ideasenvision_profiles.n_active = :n_active,
                                                tb_ideasenvision_profiles.c_usermod = :c_usermod,
                                                tb_ideasenvision_profiles.d_datemod = NOW()
                                            WHERE tb_ideasenvision_profiles.n_coduser = :n_coduser
                                                AND tb_ideasenvision_profiles.n_profiletype = :n_profiletype;")
                                ->execute(
                                            array(
                                                    ':n_active'=>$vActive,
                                                    ':c_usermod'=>$vUserMod,
